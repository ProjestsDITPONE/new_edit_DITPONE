...
class Main extends Component {
  ...
  //  alert(enabled);
      ...
      messaging().onMessage(async (remoteMessage) => {
        //เข้าตอน noti ยิงแล้วเปิดแอพอยู่
        const {title, body, subtitle} = remoteMessage.notification;
      ...
      messaging().onMessage(notification => {
        // console.log('onNotification1:', notification.data.type);
       ...
       // ถ้าอยู่ในแอพก็ให้ไปที่ noti เลย
      });
