...
const FormSet34_History = Passing => {
  return (
      ...
      <View style={Style.detailContainer}>
        ...
        {!Passing.history ? (
          <View>
            ...
            <Text style={Style.textDetail}>
              {Passing.params.incType_id.l != null
                ? Passing.params.incType_id.l
                : '-'}
            </Text>
          </View>
        ) : (
          <View>
            ...
            <Text style={Style.textDetail}>
              {Passing.params.incType_name != null
                ? Passing.params.incType_name
                : '-'}
            </Text>
          </View>
        )}
        ...
        <Text style={Style.textDetail}>
          {Passing.params.caseDtl_damage_val != ''
            ? Passing.params.caseDtl_damage_val
            : '-'}{' '}
          {Passing.params.curren_id.l != '' ? Passing.params.curren_id.l : '-'}{' '}
          {/*Route */}
        </Text>
...
export default FormSet34_History;
