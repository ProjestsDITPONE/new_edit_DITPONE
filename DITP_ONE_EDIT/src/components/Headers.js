      ...
      <Animated.View
        ...
        <TouchableOpacity
          ...
          <Image
            style={[
              styles.IconNoti,
              {width: 22, height: 22, top: 5, marginRight: 5},
            ]}
        ...
        <TouchableOpacity
          ...
          style={[
            styles.ViewIconNoti,
            { marginLeft: Platform.OS === 'android' ? -6 : 0},
          ]}
          onPress={() => this.props.navigation.navigate('ListNotiScreen')}>
          ...
          <Image
            style={[
              styles.IconNoti,
              {width: 25, height: 25, top: 2, marginRight: 2},
            ]}
