...
const FlagText = props =>
  React.createElement(
    CountryText,
    Object.assign({}, props, {style: styles.something}),
  );
  ...
  ({
    ...
    return React.createElement(
      ...
      countryCode
        ...
        : React.createElement(FlagText, null, placeholder),
      withCountryNameButton && countryName
        ? React.createElement(FlagText, null, countryName + ' ')
        : null,
      withCurrencyButton && currency
        ? React.createElement(FlagText, null, `(${currency}) `)
        : null,
      withCallingCodeButton && callingCode
        ? React.createElement(FlagText, null, `+${callingCode}`)
        : null,
    );
  },
);
export const FlagButton = ({
  ...
  return React.createElement(
    TouchableOpacity,
    {activeOpacity: 0.7, onPress: onOpen, disabled: close},
    React.createElement(
      View,
      {
        style: [
