...
class DropDownPicker extends React.Component {
  ...
  _renderEmptyContainer = () => {
    return <View style={styles.notFound}>{this.props.searchableError()}</View>;
  };
...
DropDownPicker.defaultProps = {
  ...
  customArrowUp: (size, color) => (
    ...
    <Icon name="caretup" size={8} color="#40536d" />
    // <Icon name="caretdown" size={8} color="#40536d" />
  ),
  customArrowDown: (size, color) => (
    // <Feather name="chevron-down" size={size} color={color} />
    <Icon name="caretdown" size={8} color="#40536d" />
  ),
  customArrowUp1: (size, color) => (
    // <Feather name="chevron-up" size={size} color={color} />
    <Icon name="caretup" size={8} color="#40536d" />
    // <Icon name="caretdown" size={8} color="#40536d" />
  ),
