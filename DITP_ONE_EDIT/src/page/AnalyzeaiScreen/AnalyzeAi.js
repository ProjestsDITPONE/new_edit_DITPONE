        ...
        <ListItem
          ...
          subtitle={
            <View>
              ...
              >
                <View
                  style={[Styles.ViewSub10, { marginHorizontal: ViewScale(2) }]}
                >
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1, backgroundColor: "#FFFFFF", zIndex: -1 }}>
        ...
        <View
          style={{ marginTop: Platform.OS === "android" && 90 }}
        />
        ...
        <View style={{ flex: 1 }}>
          <FlatList
            ...
            ListHeaderComponent={
              <View style={{ flex: 1, marginBottom: ViewScale(10) }}>
                <View style={styles.container}>
                  <View style={{ flex: 0.5, }}>
                    <Svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="100%"
                      height={ViewScale(275)}
                      viewBox="0 0 672 315"
                      id="svg5249"
                    >
                      {/* Africa */}
                      ...
                      >
                        ...
                        >
                          <Text
                            style={{ fontSize: ViewScale(18),color: "#568ae0", textAlign: "center" }}
                          >
                            Africa
                          </Text>
                        </View>
                  ...
                  >
                    ...
                    >
                      <Text style={{ fontSize: ViewScale(15) }}>
                        {I18n.t("transalte_negative_news")}
                      </Text>
                    </View>
                    <View
                      style={{
                    ...
                    >
                      <Text style={{ fontSize: ViewScale(15) }}>
                        {I18n.t("transalte_positive_news")}
                      </Text>
                    </View>
                  </View>
                          ...
                          >
                            ...
                            >
                              <View style={Styles.inview1}>
                                ...
                                <View
                                  style={[Styles.inviewicon4, { flex: 0.25 }]}
                                >
                                  <Icon
                                    name="chevron-down"
                                    size={ViewScale(20)}
            ...
            >
              <Image
                style={{
                  width: ViewScale(24),
                  height: ViewScale(24),
                  top: Platform.OS === "ios" ? ViewScale(6) : ViewScale(14),
                  marginHorizontal: ViewScale(5),
                }}
                source={require("../../image/searchbluex.png")}
              />
