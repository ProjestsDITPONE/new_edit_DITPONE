...
const dataCkniti = [
  {type: '1', textname: I18n.locale === 'th' ? 'คนไทย' : 'Thai Person'},
  {type: '2', textname: I18n.locale === 'th' ? 'คนต่างชาติ' : 'Foreigner'},
];
...
class DevlopRegister extends React.Component {
    ...
    try {
      ...
      if (value.ID !== undefined && value.ID !== null && value.ID !== '') {
        ...
        if (response.res_text === 'success !') {
          ...
          alert(I18n.t('translate_NodataCare') + value.ID + I18n.t('alert_in_system'));
        }
      } else {
  ...
  SaveSearchCorparateAuto = async values =>{
    try{
      ...
      console.log(
        'SaveSearchCorparateAutoSucesss1' + JSON.stringify(response),
      );
  ...
  _sendDeleteidProduct = async value => {
    try {
      ...
      if (this.state.idDelectproduct != null) {
        ...
        if ((response.result.success = true)) {
          this.setState({DeleteProduct: false, dataProduct: [],checkBoxIDdeleteproduct:[]});
          this._geDataProduct();
        }
      } else {
        ...
        <CheckBox
          ...
          title={
            <TouchableOpacity
              ...
              <Text numberOfLines={2} style={{color: '#73838f', fontSize: 20}}>
                {item.ProductCategory}
              </Text>
              <Text numberOfLines={1} style={{color: '#163c70', fontSize: 20}}>
        ...
        <ImageBackground
          ...
          <View
            style={{
              ...
              <Text  style={{color:'#73838f',fontSize:19,marginHorizontal:10}}> 
               {/* {index+1}{'. '}  */}
               { I18n.locale == 'th'
      ...
      <View
                            ...
                            <ImageBackground
                              ...
                              <ImageBackground
                                ...
                                <TextInput
                                  ...
                                  <Text style={{fontSize:20,fontFamily: 'PSL Kittithada Pro'}}>
                                  {this.state.textbusinessTypeOther}
                                  </Text>
                                ...
                                <View
                                  ...
                                  <View style={{flex: 1, marginTop: 15}}>
                                    ...
                                    <RNPickerSelect
                                      mode="dropdown"
                                      placeholder={{
                                        label: I18n.t('transalte_select_type_product'),
                                        value: 0,
                                      }}
                                      useNativeAndroidPickerStyle={false}
                                      _fixAndroidTouchableBug_={true}
                                  ...
                                  <View style={Styles.viewsearchIDcompany1}>
                                    <View style={Styles.viewsearchIDcompany}>
                                      ...
                                      <TextInput
                                        keyboardType="numeric"
                                        onChangeText={e => {
                                          this.setState({searchTextcompany: e});
                                        }}
                                      ...
                                      <ImageBackground
                                        ...
                                        <View
                                          ...
                                          <View
                                            ...
                                            <Text
                                              style={Styles.texttitlecompany}>
                                              {I18n.t('transalte_company_business_eng')}
                                            </Text>
                                            <Text style={Styles.textredcompany}>
                                              *
                                            </Text>
                                    ...
                                    <View style={{flex: 1}}>
                                      <TouchableOpacity
                                        ...
                                        <Text
                                          ...
                                          {I18n.t('transalte_Search_contact_history')}
                                        </Text>
                                      </TouchableOpacity>
                                      <View
                                        style={{
        ...
        {this.state.checkpopupaddmember && (
          <Overlay
            ...
            onBackdropPress={() => this.setState({checkpopupaddmember: false})}>
            <ScrollView style={{}}>
              ...
              <View
                ...
                <TextInput
                  ...
                  style={{
                    ...
                    fontSize: 20, flex: 1, color: '#0D0C0C'}}
                                ...
                                <TouchableOpacity
                                  onPress={() => {
                                    if (this.state.Addcompany === false) {
                                      ...
                                      alert(I18n.t('alert_Please_add_information'));
                                    } else if (
                                      this.state.dataProduct.length === 0
                                    ) {
                                      alert(I18n.t('alert_Please_add_product_info'));
