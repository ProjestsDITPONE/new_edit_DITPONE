...
const {height_screen, width__screen} = Dimensions.get('screen');
    ...
    if (PINCodeck === '') {
      ...
      if (enteredPinNewlogin.length === 6) {
        ...
        if (enteredPinNewlogin === PINCodeck) {
          ...
          alert(I18n.t('transalte_Invalid_passcode'));
          // removeUserSession()
          pinViewNewlogin.current.clearAll();
        }
      } else {
    ...
    <>
      ...
      {PassPINCode === 'set' && (
        <SafeAreaView
          ...
          {/* <View style={{paddingHorizontal: 25,width:width__screen}}> */}
            ...
            <ReactNativePinView
              ...
              customLeftButton={
                showRemoveButton ? (
                  ...
                  <View>
                    <Text style={{fontSize: ViewScale(30), color: '#FFF'}}>{I18n.t('transalte_Delete_Code')}</Text>
                  </View>
                ) : (
                  undefined
                )
      ...
      {PassPINCode === 'confirm_set' && (
        <SafeAreaView
          ...
          <Text
           ...
           {I18n.t('transalte_Verify_Passcode')}
          </Text>
          <View style={{paddingHorizontal: 25,width:ViewScale(450)}}>
            <ReactNativePinView
              inputSize={ViewScale(20)}
      ...
      {PassPINCode === 'ChagePIN' && (
        <SafeAreaView
          ...
          <Text
           ...
           {/* <View style={{paddingHorizontal: 25, width:width}}> */}
          <View style={{paddingHorizontal: 25,width:ViewScale(450)}}>
            <ReactNativePinView
              inputSize={ViewScale(20)}
              ref={pinViewNewChage}
            ...
            <ReactNativePinView
              ...
              customRightButton={
                CheackFaceIDTouchID === true ? (
                  <Icon1 name={'fingerprint'} size={ ViewScale(36)} color={'#FFF'} />
                ) : (
                  undefined
                )
              }
