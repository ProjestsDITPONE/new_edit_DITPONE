export default {
  ...
  translate_By: 'by',
  translate_Toppickanddoolan: 'Nongdoola choose for Top Pick',
  translate_Recommended_activities: 'Recommended activities',
  ...
  translate_returnBack: 'Retrospect',
...
transalte_delete_product: 'Delete',
transalte_add_product: 'Add Product',
transalte_delete_participant: 'Delete',
...
translate_Products: 'Product',
transalte_location: 'Location' ,
transalte_Demand: 'Need',
transalte_Product_TraedAc: 'Product',
translate_All_Location: 'All Location',
transalte_Accompanying_Information: 'Accompanying Info',
transalte_Contact_Information: 'Contact Info' ,
transalte_Expenses: 'Expenses',
transalte_Attachment_if_have:'Attachment (If Have)',
transalte_Attachment:'Attachment',
transalte_importer: 'Importer',
transalte_agent: 'Agent',
transalte_factory_manufacturer: 'Factory / Manufacturer',
transalte_Department_Members: 'Department membership number',
transalte_Department_Category: 'Department membership type',
transalte_Number_Juristic: 'corporate number (Username)',
transalte_Company_ฺBusiness: 'Company / Business',
transalte_Faculty_member_info: 'Faculty member information',
transalte_Condition_details: 'In the event that the company does not produce the product itself There must be a letter of certifying from the company that manufactures the product stating that the product has been manufactured. Along with attaching a copy of the product quality standard certificate from the relevant department of the company that produces the product. (Every item that the company that produces the product has been certified for product quality standards). Every document must be signed certifying true copy by the authorized signatory of the company producing the product and affixing the seal of the company producing the product.',
